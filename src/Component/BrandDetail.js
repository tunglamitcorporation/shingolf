        ...
        <div>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12 offset-4">
                                <div class="feature__title">Ha Noi</div>
                            </div>
                        </div>
                    </div>
            </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <ul class="breadcrumb__list">
                                   ...
                                   <li class = "breadcrumb__item">
                                        <a class ="breadcrumb__title" href="/AzumayaClone/html/hanoibranchdetail.html">Ha Noi</a>
                                   </li>
                       </ul>
                    </div>
                </div>
            ...
            <div class="branch__container">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="feature__type-item" style={{height:'400px'}}>
                                <div class="col-md-5">
                                <div class="feature__type-img" >
                                </div>
                                </div>
                                <div class="col-md-7">
                                <div class="feature__type-content">
            ...
            <div class="col-md-12">
                <div class="feature__type-item" style={{height:'400px'}}>
                    ...
                    <div class="btn__detail"style={{marginTop:'70px'}}>
                        <a href="#">Click here for detail</a>
                    </div>
                    </div>
                </div>
            ...
            <div class="col-md-12">
                <div class="feature__type-item" style={{height:'400px'}}>
                    ...
                    <div class="btn__detail"style={{marginTop:'33px'}}>
                        <a href="#">Click here for detail</a>
                    </div>
                    </div>
                </div>
            ...
            <div class="content__news" style={{marginLeft:'15%',height:'250px'}}>
                <h2 class ="content__news-title">What's new ?</h2>
                 <ul class="content__news-list" style={{marginTop:'20px'}}>
                    <li class="content__news-item">
                        <span class="content__news-date">Jul 7<sup>th</sup> 2023</span>
                        <span class="content__news-branch">Hanoi</span>
                        <span class="content__news-link">
