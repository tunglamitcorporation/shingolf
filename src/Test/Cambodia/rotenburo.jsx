...
const RotenburoPP = () => {
  ...
  className="container-fluid" style={{marginTop: 20}}>
    ...
    <div className="container">
      <div className="row">
          <div className="col-md-12">
            <img className='image-holder' style={{width: "100%", height: "100%"}} src="https://res.cloudinary.com/dtdfsaaei/image/upload/v1704681366/AzumayaWeb/rotenburo-pp_uvfdkl.jpg" alt="" />
          </div>
      </div>
    </div>
    </TabPanel>
