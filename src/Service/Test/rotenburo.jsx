...
const Rotenburo = () => {
  ...
  className="container-fluid" style={{marginTop: 20}}>
    ...
    <div className="container">
      ...
      <img className='image-holder' style={{width: "80%", height: "100%"}} src="https://res.cloudinary.com/dtdfsaaei/image/upload/v1705303977/AzumayaWeb/rotenburo__3_lbdmwi.jpg" alt="" />
          </div>
    </div>
    </TabPanel>
  </Tabs>
