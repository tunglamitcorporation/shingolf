...
export default function VietnamService() {
  ...
  className="container-fluid" style={{marginTop: 20}}>
    ...
    <div className="container">
      <div className="row justify-content-center">
      <img className='image-holder' style={{width: "80%", height: "100%"}} src="https://res.cloudinary.com/dtdfsaaei/image/upload/v1705543853/AzumayaWeb/rotenburo__3_pnbqr3.jpg" alt="" />
      </div>
    </div>
    </TabPanel>
    <TabPanel>
