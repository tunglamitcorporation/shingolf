...
function Reservation({token}) {
  ...
  const [guestInformation, setGuestInformation] = useState({
    guest1: {familyName:'', givenName: '', gender: 'Mr.', day: 'Day', month: 'Month', year: 'Year', secondFamilyName:'', secondGivenName:'',secondGender:'', secondDay:'', secondMonth:'', secondYear:'', booker:'',bookerName:'', email:'', phone:'', roomType:'Non Smoking',contract:'No Contract',company:'',discount:'', vat:'', payMethod:''},
    guest2: {familyName:'', givenName: '', gender: 'Mr.', day: 'Day', month: 'Month', year: 'Year', secondFamilyName:'', secondGivenName:'',secondGender:'', secondDay:'', secondMonth:'', secondYear:'', roomType:'Non Smoking',contract:'No Contract',company:'',discount:'', vat:'', payMethod:''},
    guest3: {familyName:'', givenName: '', gender: 'Mr.', day: 'Day', month: 'Month', year: 'Year', secondFamilyName:'', secondGivenName:'',secondGender:'', secondDay:'', secondMonth:'', secondYear:'', roomType:'Non Smoking',contract:'No Contract',company:'',discount:'', vat:'', payMethod:''},
    guest4: {familyName:'', givenName: '', gender: 'Mr.', day: 'Day', month: 'Month', year: 'Year', secondFamilyName:'', secondGivenName:'',secondGender:'', secondDay:'', secondMonth:'', secondYear:'', roomType:'Non Smoking',contract:'No Contract',company:'',discount:'', vat:'', payMethod:''},
    guest5: {familyName:'', givenName: '', gender: 'Mr.', day: 'Day', month: 'Month', year: 'Year', secondFamilyName:'', secondGivenName:'',secondGender:'', secondDay:'', secondMonth:'', secondYear:'', roomType:'Non Smoking',contract:'No Contract',company:'',discount:'', vat:'', payMethod:''},
