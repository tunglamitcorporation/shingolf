...
const ImageZoom = ({ src, alt }) => {
  ...
  return (
    <Container
      ...
      >
        <Image ref={sourceRef} alt="source" source="https://shingolf.vn/image/product/image/A0001_image1.png" />
        <Target
          ref={targetRef}
          alt="target"
          opacity={opacity}
          offset={offset}
          source="https://shingolf.vn/image/product/image/A0001_image1.png"
        />
      </Container>
  );
};
